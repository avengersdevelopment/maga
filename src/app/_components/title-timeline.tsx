...
export const TitleTimeline = () => {
  return (
    <div className="flex h-[10vh] w-full justify-center bg-white md:h-[50vh] py-16">
      <div className="relative h-full w-[90vw]">
        ...
        <div className="absolute bottom-0 left-0 right-0 top-8 md:top-10">
          <p
            className="text-nowrap pr-0 pt-0 text-end text-5xl font-bold text-[#061936]/10 md:text-[200px]"
            style={{ lineHeight: 1 }}
          >
            TRUMP
          </p>
