...
export const Header = ({ total }: HeaderProps) => {
  return (
    <header className="fixed top-0 z-50 w-full backdrop-blur-sm flex justify-center">
      <div className="max-w-[90vw] flex h-full w-full items-center justify-between py-2 mt-8">
